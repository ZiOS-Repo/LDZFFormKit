...
@implementation UIImage (IURotate)
...
{
    return [self iu_rotate:UIImageOrientationDownMirrored];
}

/** 水平翻转 */
- (UIImage *)iu_flipHorizontal
{
    return [self iu_rotate:UIImageOrientationUpMirrored];
}
...
{
    return [self iu_imageRotatedByRadians:IUDegreesToRadians(degrees)];
}
