//
//  LdzfIconEdgeInsetsLabel.m
//  LdzfEdgeInsetsLabel
//
//  Created by zhuyuhui on 2020/9/7.
//

#import "LdzfIconEdgeInsetsLabel.h"

@interface LdzfIconEdgeInsetsLabel ()

@property (nonatomic, weak) UIView  *oldIconView;

@end

@implementation LdzfIconEdgeInsetsLabel
...
- (void)drawTextInRect:(CGRect)rect {
    ...
    if (self.iconView) {
        ...
        } else if (self.direction == IconAtRight) {
