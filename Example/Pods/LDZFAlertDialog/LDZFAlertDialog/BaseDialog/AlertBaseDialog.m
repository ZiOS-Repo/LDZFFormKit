...
- (void)showContainerViewWithCompletion:(void (^)(BOOL))completion {
    ...
    [self.containerView mas_updateConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(self.view).offset(self.containerView.qmui_height);
    }];
...
- (UIImage *)imageFromCustomBundle:(NSString *)name {
    ...
    NSString *bundlePath = [[NSBundle bundleForClass:[self class]].resourcePath
        stringByAppendingPathComponent:[NSString  stringWithFormat:@"/%@.bundle",@"LDZFAlertDialogResources"]];
