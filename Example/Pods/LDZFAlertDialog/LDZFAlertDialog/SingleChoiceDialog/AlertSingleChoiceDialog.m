...
#pragma mark - 其他
    // 创建pickerView
    _pickerView = [[LdzfCustomPickerView alloc] initWithFrame:CGRectMake(0, 44.f, self.view.qmui_width, 0) delegate:self];
...
- (void)setupInitialData {
    ...
    LdzfPickerViewComponent   *component  = [LdzfPickerViewComponent pickerViewComponentWithRows:rows componentWidth:self.view.qmui_width];
