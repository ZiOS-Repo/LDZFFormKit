...
#import "FormAttrCellModel.h"
#import "FormAttrCell.h"

@implementation FormAttrCellModel
- (instancetype)init
{
    self = [super init];
    if (self) {
...
- (void)calculateAttrHeight {
    UILabel *_keyLable = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, FORM_ScreenWidth - self.bodyPadding.left - self.bodyPadding.right, 0)];
