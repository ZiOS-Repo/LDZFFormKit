...
@property(nonatomic, strong) FormSwitchCellModel *dataItem;
@end
...
- (void)loadContent {
    [super loadContent];
    if ([self.data isKindOfClass:[FormSwitchCellModel class]]) {
...
- (void)switchValueChanged: (id)sender{
    ...
    if (self.switchCellDelegate && [self.switchCellDelegate respondsToSelector:@selector(switchCellOfValueChanged:)]) {
        [self.switchCellDelegate switchCellOfValueChanged:self];
    }
