...
@end
@interface QnmFormPlusReduceScheme : NSObject
@property(nonatomic, copy) NSString *color;
@property(nonatomic, copy) NSString *font;
@property(nonatomic, copy) NSString *placeholderFont;
@property(nonatomic, copy) NSString *placeholderTextColor;
...
@property(nonatomic, copy) NSString *reduceEnable;
@property(nonatomic, copy) NSString *plusEnable;
@property(nonatomic, copy) NSString *inputBoxWidth;
...
@property(nonatomic, strong) QnmFormPlusReduceScheme    *plusReduceIN;
